...
/* 見出し */
.lobby-page :deep(.online-lobby-content .user-area h2),
.lobby-page :deep(.online-lobby-content .action-area h2),
.lobby-page :deep(.online-lobby-content .status-area h2) {
  color: #193257;
  text-shadow: none;
}
